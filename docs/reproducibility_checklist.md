...
- [x] `figures/scale_exception_combined_success.png`
- [x] `figures/scale_exception_diagnostics.png`
- [x] `figures/scale_exception_stress_sweep.png`
- [x] `figures/scale_exception_ablation.png`
- [x] `figures/scale_exception_safety_regret.png`
- [x] `paper/main.tex`
