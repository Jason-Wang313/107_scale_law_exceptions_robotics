...
Honest strongest claim: `Find embodied regimes where scaling data/model size predicts the wrong failure boundary.` is a plausible branch-structured mechanism for robot foundation model scaling, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
